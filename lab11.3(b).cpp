...
void CreateBIN(char* fname) {
	...
	do {
		...
		switch (student.spesialnist) {
		case KN:
			cout << "    оцінка з програмування: ";
			cin >> student.mark_prog;
			break;
		case INF:
			cout << "    оцінка з чисельних методів: ";
			cin >> student.mark_ch_meth;
			break;
		default:
			cout << "    оцінка з педагогіки: ";
			cin >> student.mark_ped;
			break;
		}
...
void Print(char* fname) {
	...
	while (fin.read((char*)&student, sizeof(Student))) {
		...
		switch (student.spesialnist) {
		case KN:
			cout << "| " << setw(13) << right << student.mark_prog << " ";
			cout << "|                 ";
			cout << "|            ";
			break;
		case INF:
			cout << "|               ";
			cout << "| " << setw(15) << right << student.mark_ch_meth << " ";
			cout << "|            ";
			break;
		default:
			cout << "|               ";
			cout << "|                 ";
			cout << "| " << setw(10) << right << student.mark_ped << " ";
			break;
		}
